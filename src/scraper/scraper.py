...
def setup_logging():
    ...
    It uses a custom format that prefixes each log message with "VC_ASSISTANT"
    ...
    logging.basicConfig(
        ...
        level=logging.INFO,
        format="VC_ASSISTANT: %(asctime)s - %(levelname)s - %(message)s",
    )
    ...
    stderr_handler.setFormatter(
        logging.Formatter("VC_ASSISTANT: %(asctime)s - %(levelname)s - %(message)s")
    )
